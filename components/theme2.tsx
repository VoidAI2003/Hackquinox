'use client';  // Add this at the top to convert the component to a client component
...
export default function PS() {
  // Array to store theme details
  const themes = [
    {
      title: "Web Development",
      description: "Craft functional, stunning websites and dynamic web apps where creativity meets innovation.",
      image: "/Web.png", 
    },
    {
      title: "AI & ML",
      description: "Shape the future with intelligent systems and data-driven solutions.",
      image: "/aiml.png", 
    },
    {
      title: "Cybersecurity / Blockchain",
      description: "Secure the digital world and innovate with blockchain-powered trust.",
      image: "/open.png", 
    },
    {
      title: "Open Innovation",
      description: "Break boundaries and bring bold ideas to life in any domain.",
  ...
  return (
    ...
    >
      ...
      <div className="absolute left-0 top-10 items-center bg-yellow">
        <h2 
          className={`${orbitron.className} absolute left-[131px] top-[27px] text-[60px] font-semibold text-white z-20 whitespace-nowrap`}
        >
          QUEST
        </h2>
      </div>
  ...
  {themes.map((theme, index) => (
    <div
      key={index}
      className="cards flex flex-col justify-center items-center p-4 shadow-md"
      style={{
        borderRadius: '25px',
        margin: '30px',
      }}
    >
      ...
      />
      {/* Title */}
      <h3 className={`${orbitron.className} text-[24px] font-bold mt-4 text-center`}>
        {theme.title}
      </h3>
      {/* Description (Hidden by default, shown on hover) */}
      <div className="description text-[16px] text-white mt-2 text-center">
        {theme.description}
      </div>
    </div>
  ))}
